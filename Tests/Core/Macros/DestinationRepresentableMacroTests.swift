...
struct DestinationRepresentableMacroTests {
    ...
    @Test
    func
        `expansion should return nil for all cases when no case is marked with OriginKey and cases are enumerated`()
    {
        assertMacroExpansion(
            """
            @DestinationRepresentable
    ...
    @Test
    func
        `expansion should return nil for all cases when no case is marked with OriginKey and cases are enumerated and in different order`()
    {
        assertMacroExpansion(
            """
            @DestinationRepresentable
    ...
    @Test
    func
        `expansion should generate a static key and return it when a single case is marked with OriginKey`()
    {
        assertMacroExpansion(
            """
            @DestinationRepresentable
    ...
    @Test
    func
        `expansion should generate a static key for every case marked with OriginKey when multiple cases are marked`()
    {
        assertMacroExpansion(
            """
            @DestinationRepresentable
    ...
    @Test
    func
        `expansion should generate a static key for every case when all cases are marked with OriginKey`()
    {
        assertMacroExpansion(
            """
            @DestinationRepresentable
    ...
    @Test
    func
        `expansion should generate a separate static key for each element when multiple cases share the same OriginKey declaration`()
    {
        assertMacroExpansion(
            """
            @DestinationRepresentable
    ...
    @Test
    func
        `expansion should ignore associated values and still generate the correct static key when a case has named associated values`()
    {
        assertMacroExpansion(
            """
            @DestinationRepresentable
    ...
    @Test
    func
        `expansion should generate the correct extension when the enum is nested inside another type`()
    {
        assertMacroExpansion(
            """
            struct Container {
    ...
    @Test
    func
        `expansion should generate members and constrained conformance for a generic enum without OriginKey`()
    {
        assertMacroExpansion(
            """
            @DestinationRepresentable
    ...
    @Test
    func
        `expansion should produce an error when DestinationRepresentable is applied to a protocol`()
    {
        assertMacroExpansion(
            """
            @DestinationRepresentable
